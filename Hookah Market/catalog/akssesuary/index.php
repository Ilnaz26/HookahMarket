...
<section class="catalog_top" style="background-image: url(/img/akssesuary_top.jpg);">
	<div class="container">
		...
		<h2 class="catalog_title">Аксессуары</h2>
	</div>
</section>
...
<section>
	<div class="container">
		...
		<div class="catalog_head_btns">
				<a href="#" class="ch_btn active">Все модели</a>
				<a href="#" class="ch_btn">Щипцы</a>
				<a href="#" class="ch_btn">Мундштуки</a>
				<a href="#" class="ch_btn">Шланги</a>
				<a href="#" class="ch_btn">Электроплиты</a>
				<a href="#" class="ch_btn">Ершики</a>
				<a href="#" class="ch_btn">Уплотнители</a>
				<a href="#" class="ch_btn">Коннекторы</a>
				<a href="#" class="ch_btn">Колпаки</a>
				<a href="#" class="ch_btn">Кадило</a>
				<a href="#" class="ch_btn">Мелассоуловители</a>
				<a href="#" class="ch_btn">Устройства контроля жара</a>
				<a href="#" class="ch_btn">Шило и вилки</a>
				<a href="#" class="ch_btn">Прочее</a>
			</div>
